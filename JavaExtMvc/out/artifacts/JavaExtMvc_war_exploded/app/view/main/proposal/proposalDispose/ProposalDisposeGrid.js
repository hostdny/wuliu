 ...
 */
Ext.define('ExtFrame.view.main.proposal.proposalDispose.ProposalDisposeGrid', {
    extend: 'Ext.grid.GridPanel',
    alias: 'widget.proposalDisposeGrid',
    ...
    initComponent: function () {
        ...
        me.dockedItems = [{
            ...
            itemId: 'gridtoolbar',
            ename: 'proposalDispose',//搜索栏父级grid 对应类名称，用于GridSearchToolbar查找父级grid对象
            hasSearch: false,
            dock: 'top',
            items: []
        }, {
