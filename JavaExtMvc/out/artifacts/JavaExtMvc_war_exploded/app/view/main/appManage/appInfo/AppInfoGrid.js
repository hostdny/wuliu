Ext.define('ExtFrame.view.main.appManage.appInfo.AppInfoGrid', {
    extend: 'Ext.grid.GridPanel',
    alias: 'widget.appInfoGrid',
    fit: true,
    stripeRows: true,
    initComponent: function () {
        ...
        me.columns = [
            ...
            {text: '应用编码', dataIndex: 'appCode'},
            {text: '中文名称', dataIndex: 'appCName', searchable: true},
            {text: '英文名称', dataIndex: 'appEName', searchable: true},
            {
                text: '应用类别', dataIndex: 'appType', renderer: function (v) {
                if (v == 1) {
                    return 'IOS';
                }
                else if (v == 0) {
        ...
        me.store = Ext.create('ExtFrame.store.Buttons', {
            ...
            proxy: {
                type: 'ajax',
                url: Tools.Method.getAPiRootPath() + "/appInfo/pagedQueryByBean.do",
                reader: {
                    type: 'json',
