 ...
 */
Ext.define('ExtFrame.view.main.attorneyBoxManage.attorneyBox.DownLoadGrid', {
    extend: 'Ext.grid.GridPanel',
    alias: 'widget.downLoadAttachmentGrid',
    fit: true,
    stripeRows: true,
    initComponent: function () {
        ...
        me.store = Ext.create('ExtFrame.store.Test', {
            ...
            proxy: {
                type: 'ajax',
                url: Tools.Method.getAPiRootPath()+ "/attachment/pagedQueryByBean.do",
                reader: {
                    type: 'json',
