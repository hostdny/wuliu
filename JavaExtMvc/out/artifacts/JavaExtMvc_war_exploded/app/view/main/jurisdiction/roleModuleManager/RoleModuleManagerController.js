 ...
 */
Ext.define('ExtFrame.view.main.jurisdiction.roleModuleManager.RoleModuleManagerController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.roleModuleManagerController',
    ...
    onClickButtonSave: function () {
        ...
        if (roleId == '' || roleId == undefined) {
            ...
            alert("checkedModule----------" + checkedModule);
            return;
...
function RoleModuleClick(o, actionType) {
    var orgModuleManagerGrid = Ext.getCmp('roleModuleManager');
