 ...
 */
Ext.define('ExtFrame.view.main.jurisdiction.roleModuleManager.RoleModuleManager', {
    ...
    requires: [
        ...
        'Ext.tree.*',
        'Ext.ux.CheckColumn',
        'ExtFrame.view.main.jurisdiction.roleModuleManager.RoleModuleManagerController'
    ],
    xtype: 'tree-grid',
    controller: 'roleModuleManagerController',
    id: 'roleModuleManager',
    ename: '',
            ...
            items: [{
                ...
                listeners: {
                    select: function (me, record, eOpts) {
                        ...
                        Ext.getCmp('roleModuleManager').store.getProxy().extraParams = {
                            "moduleId": '00000000000000000000000000000000',
                            "roleId": record.data.id
                        };
                        Ext.getCmp('roleModuleManager').store.reload();
                    }
