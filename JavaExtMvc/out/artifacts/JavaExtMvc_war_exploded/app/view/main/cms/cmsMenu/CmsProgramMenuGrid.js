 ...
 */
Ext.define('ExtFrame.view.main.cms.cmsMenu.CmsProgramMenuGrid', {
    ...
    alias: 'widget.cmsProgramMenuGrid',
    fit: true,
    rootVisible: false,
        ...
        me.columns = [
            {
                ...
                text: '是否在网站端显示', dataIndex: 'isShow', width: 100, renderer: function (v) {
                    if (v == "0") {
                        return '显示';
                    } else if (v == "1") {
                        return '不显示';
