Ext.define('ExtFrame.view.main.tipOff.invalidTipOff.InvalidTipOffGrid', {
    extend: 'Ext.grid.GridPanel',
    alias: 'widget.invalidTipOffGrid',
    ...
    initComponent: function () {
        ...
        me.store = Ext.create('ExtFrame.store.User', {
            ...
            proxy: {
                type: 'ajax',
                url: Tools.Method.getAPiRootPath() + "/tipMessage/pagedQueryByBean.do",
                reader: {
                    type: 'json',
        ...
        me.dockedItems = [{
            ...
            itemId: 'gridtoolbar',
            ename: 'InvalidTipOff',//搜索栏父级grid 对应类名称，用于GridSearchToolbar查找父级grid对象
            hasSearch: false,
            dock: 'top',
            items: []
        }, {
