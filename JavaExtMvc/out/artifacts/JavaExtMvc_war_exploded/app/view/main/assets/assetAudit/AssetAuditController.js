 ...
 */
Ext.define('ExtFrame.view.main.assets.assetAudit.AssetAuditController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.assetAuditController',
    ...
    onClickButtonSave: function () {
        ...
        if (form.isValid()) {
            ...
            if (record) {
                ...
                Tools.Method.ExtAjaxRequestEncap(Tools.Method.getAPiRootPath() + '/assentRecord/jcksaveAssent.do', 'POST', record, true, function (jsonData) {
                    if (jsonData) {
