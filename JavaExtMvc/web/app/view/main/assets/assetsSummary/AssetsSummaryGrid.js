/**
 * Created by zzw on 2016/7/26.资产汇总
 */
Ext.define('ExtFrame.view.main.assets.assetsSummary.AssetsSummaryGrid', {
    extend: 'Ext.grid.GridPanel',
    alias: 'widget.assetsSummaryGrid',
    fit: true,
    stripeRows: true,
    id:"assetsSummaryGridId",
    initComponent: function () {
        var me = this;

        /********************** 根据具体业务需要适当修改 ***********************/
        var pageSize = 10;//分页条数
        var OrderField = 'aType';//默认排序字段
        ...
        me.store = Ext.create('ExtFrame.store.Role', {
            ...
            proxy: {
                type: 'ajax',
                url: Tools.Method.getAPiRootPath()+ "/assentRecord/queryAssentRecordLast.do",
                reader: {
                    type: 'json',
