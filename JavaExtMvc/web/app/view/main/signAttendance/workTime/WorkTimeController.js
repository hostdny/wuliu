 ...
 */
Ext.define('ExtFrame.view.main.signAttendance.workTime.WorkTimeController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.workTimeController',

    onClickButtonDel: function () {
        var ActionDelete = Tools.Method.getAPiRootPath() + '/signAttendanceList/delete.do';
        var panel = this.getView();
        var workTimeGrid = Ext.getCmp('workTimeGrid');
        var selectRows = workTimeGrid.selModel.selected.items;//获取grid选中行
        //至少选择一项数据
    ...
    onClickButtonAdd: function () {
        ...
        var win = view.down('#workTimeWindow');
    ...
    onClickButtonEdit: function () {
        ...
        var view = this.getView();
        var grid = view.down("#workTimeGrid");//获取当前grid控件
    ...
    onClickButtonSave: function (btn) {
        if (!Tools.Method.IsLogin())
            return;
        var view = this.getView();
        var form = view.down('#workTimeWindowForm');
        var grid = Ext.getCmp("workTimeGrid");//获取当前grid控件
        var win = btn.up('window');
