 ...
 * 提取了一个停靠组件的类，方便维护
 */
Ext.define('ExtFrame.view.main.region.GridSearchToolbarNoAdd', {
    extend: 'Ext.toolbar.Toolbar',
    alias: 'widget.gridSearchToolbarNoAdd',
    hasSearch: true,
    autoScroll: true,
    searchCols: [],//可查询字段数据
    hasBtn: true,
    ...
    initComponent: function () {
        ...
        if (me.hasBtn) {
            ...
            Tools.Method.ExtAjaxRequestEncap(Tools.Method.getAPiRootPath() + '/module/queryModuleButtons.do', 'GET', {
                'moduleEname': me.ename
            }, false, function (jsonData) {
                //写入缓存
                //$.data(ExtBtns, me.ename, jsonData);
            ...
            //if ($.data(ExtBtns, me.ename) == undefined) {
            //
            //}
            //取出页面按钮缓存
            //var btns = $.data(ExtBtns, me.ename);
