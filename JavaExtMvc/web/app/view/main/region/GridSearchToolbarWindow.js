 ...
 * 提取了一个停靠组件的类，方便维护 
 */
Ext.define('ExtFrame.view.main.region.GridSearchToolbarWindow', {
    extend: 'Ext.toolbar.Toolbar',
    alias: 'widget.gridSearchToolbarWindow',
    hasSearch: true,
    autoScroll: true,
    searchCols: [],//可查询字段数据
    hasBtn: true,
        ...
        if (me.hasSearch) {
            ...
            */
            ...
            me.items.push({
                text: '搜索',
                glyph: 0xf00e,
                handler: 'onClickSearchWindow'
            });
            me.items.push({
                text: '增加条件',
                glyph: 0xf0a9,
                handler: 'onClickAddSearchWindow'
            });
            me.items.push({
                text: '重置查询',
                glyph: 0xf122,
                handler: 'onClickClearWindow'
            });
            me.items.push({
