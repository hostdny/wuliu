Ext.define(
    'ExtFrame.view.main.sys.moduleManager.ModuleManager',
    {
        ...
        requires: ['ExtFrame.view.main.sys.moduleManager.ModuleManagerController',
            'ExtFrame.view.main.sys.moduleManager.ModuleManagerModel',
            'ExtFrame.view.main.sys.moduleManager.ModuleGrid'],//请求MainController类
        layout: {type: 'border'},
