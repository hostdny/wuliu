 ...
 */
Ext.define('ExtFrame.view.main.exam.examScore.ExamScoreGrid', {
    ...
    initComponent: function () {
        ...
        var OrderField = 'typeOfWork';//默认排序字段
        ...
        me.columns = [
            ...
            {text: '姓名', dataIndex: 'personName', searchable: true, fieldType: 'string'},
            {text: '类别', dataIndex: 'examType', searchable: true, fieldType: 'string', width: 300},
            {text: '成绩', dataIndex: 'score', searchable: true, fieldType: 'string'}
        ];
        //构造grid store
        me.store = Ext.create('ExtFrame.store.Role', {
            ...
            proxy: {
                type: 'ajax',
                url: Tools.Method.getAPiRootPath()+ "/examJoinExam/pagedQueryByBean.do",
                reader: {
                    type: 'json',
