/**
 * Created by JIA on 2016/9/24.
 */
Ext.define('ExtFrame.view.main.briberyCrime.briberyCrimeBespeak.DownLoadGrid', {
    ...
    initComponent: function () {
        ...
        me.store = Ext.create('ExtFrame.store.User', {
            ...
            proxy: {
                type: 'ajax',
                url: Tools.Method.getAPiRootPath()+ "/briberyCrimeBespeak/queryByBuinessDate.do",
                reader: {
                    type: 'json',
